        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Quy trình rõ ràng giúp dự án minh bạch, kiểm soát tiến độ và đảm
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {steps.map((step, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-white w-full relative h-full rounded-2xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all border-b-2 ${step.borderColor}`}
                >
